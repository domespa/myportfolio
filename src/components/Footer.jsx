...
export default function Footer() {
  return (
    <footer className="footer-d">
      <div className="footer-d-inner">
        <h2 className="footer-d-name">Domenico Spampinato</h2>
        <p className="footer-d-role">Full-Stack Developer</p>

        <div className="footer-d-icons">
          <a
            href="https://github.com/domespa"
            target="_blank"
            rel="noopener noreferrer"
            aria-label="GitHub"
            className="footer-d-icon"
          >
          ...
          <a
            href="https://linkedin.com/in/domespa"
            target="_blank"
            rel="noopener noreferrer"
            aria-label="LinkedIn"
            className="footer-d-icon"
