...
// Sta fuori da Progetti() cosi' React non la rimonta a ogni render.
    ...
    <>
      ...
      <nav className="prog-nav">
        {PROJECTS.map((proj) => (
          <button
            key={proj.id}
            className={`prog-nav-item ${activeId === proj.id ? "active" : ""}`}
  ...
  return (
    <div className="prog-page">
      ...
      <aside className={`prog-sidebar ${menuOpen ? "mobile-open" : ""}`}>
        ...
        <SidebarContent activeId={active.id} onSelect={selectProject} />
      </aside>
